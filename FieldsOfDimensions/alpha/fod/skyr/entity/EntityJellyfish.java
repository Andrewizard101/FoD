...
public class EntityJellyfish extends EntityTameable
{
    private float field_70926_e;
    private float field_70924_f;
    /** Random offset used in floating behaviour */
    private float heightOffset = 11.9F;
   ...
   protected void fall(float par1) {}
     ...
     */
    public EntityJellyfish spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityJellyfish var2 = new EntityJellyfish(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityJellyfish))
        {
            return false;
        }
        else
        {
            EntityJellyfish var2 = (EntityJellyfish)par1EntityAnimal;
