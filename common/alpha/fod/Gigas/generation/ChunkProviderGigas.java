...
public class ChunkProviderGigas implements IChunkProvider
{
    ...
    /**
     * Holds the noise used to determine whether something other than stone can be generated at a location
     */
    private double[] stoneExclusivityNoise = new double[256];
    ...
    public ChunkProviderGigas(World par1World, long par2)
    {
        ...
        NoiseGeneratorOctaves[] noiseGens = {netherNoiseGen1, netherNoiseGen2, netherNoiseGen3, slowsandGravelNoiseGen, stoneExculsivityNoiseGen, netherNoiseGen6, netherNoiseGen7};
        ...
        this.stoneExculsivityNoiseGen = noiseGens[4];
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte)
    {
        ...
        this.stoneExclusivityNoise = this.stoneExculsivityNoiseGen.generateNoiseOctaves(this.stoneExclusivityNoise, par1 * 16, par2 * 16, 0, 16, 16, 1, var5 * 2.0D, var5 * 2.0D, var5 * 2.0D);
        ...
        for (int var7 = 0; var7 < 16; ++var7)
        {
            for (int var8 = 0; var8 < 16; ++var8)
            {
                ...
                int var11 = (int)(this.stoneExclusivityNoise[var7 + var8 * 16] / 3.0D + 3.0D + this.hellRNG.nextDouble() * 0.25D);
                int var12 = -1;
                byte var13 = (byte)Block.stone.blockID;
                byte var14 = (byte)Block.stone.blockID;
