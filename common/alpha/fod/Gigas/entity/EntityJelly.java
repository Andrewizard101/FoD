...
public class EntityJelly extends EntityTameable
{
   ...
   protected void fall(float par1) {}
    ...
    {
        EntityJelly var2 = new EntityJelly(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityJelly))
        {
            return false;
        }
        else
        {
            EntityJelly var2 = (EntityJelly)par1EntityAnimal;
