...
{
 public BlockGigasPortal(int id, int texture)
 {
  super(id, texture);
 ...
 public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
 {
  if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
  {
   if (par5Entity instanceof EntityPlayerMP)
   {
    ...
    {
     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterGigas(thePlayer.mcServer.worldServerForDimension(0)));
    }
   }
  }
 }
 ...
 public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
 {
  ...
  else
  {
    ...
    for (var9 = 1; var9 < 4 && par1World.getBlockId(par2, var8 + var9, par4) == this.blockID; ++var9)
   {
    ...
    if (var9 == 3 && par1World.getBlockId(par2, var8 + var9, par4) == Block.cobblestoneMossy.blockID)
   {
