...
public class TeleporterGigas extends Teleporter
{
 ...
 private final List field_85190_d = new ArrayList();
  ...
  public TeleporterGigas(WorldServer par1WorldServer)
 {
    ...
    for (int var14 = -2; var14 <= 2; ++var14)
   {
    for (int var15 = -2; var15 <= 2; ++var15)
    {
     for (int var16 = -1; var16 < 3; ++var16)
     {
      ...
      this.field_85192_a.setBlockWithNotify(var17, var18, var19, var20 ? Block.cobblestoneMossy.blockID : 0);
     }
    }
   }
    ...
    for (var19 = -1; var19 <= 1; ++var19)
   {
    for (var20 = 1; var20 < 3; ++var20)
    {
     for (var21 = -1; var21 < 3; ++var21)
     {
      ...
      var33 = var21 < 0;
      this.field_85192_a.setBlockWithNotify(var22, var23, var24, var33 ? Block.cobblestoneMossy.blockID : 0);
     }
    }
   }
  }
